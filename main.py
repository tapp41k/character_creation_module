...
def attack(char_name: str, char_class: str) -> str:
    """Вычисляет нанесёный урон выбранного героя противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Вычисляет блокированный урон выбранного героя от аттаки."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Вычисляет специальное умение выбранного героя."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Запускает выбор героя и выводит его характеристику."""
    approve_choice = None
    char_class = None
